...
import com.example.agentlifechanger.databinding.ActivityPhoneNumberBinding
        ...
        binding.btnSendOtp.setOnClickListener{
            ...
            if(IsValid() ){
                lifecycleScope.launch {
                    ...
                    modelFA.phone= binding.ccp.getFullNumberWithPlus()

                    faViewModel.updateFA(modelFA).observe(this@ActivityPhoneNumber) {
                        utils.endLoadingAnimation()
                        if (it == true) {
                            sharedPrefManager.saveUser(modelFA)
                            sharedPrefManager.putFAPhoneNumber(true)
