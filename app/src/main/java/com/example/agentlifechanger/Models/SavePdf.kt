...
class SavePdf(list:List<TransactionModel>) {
    var investmentlist=list
    fun generateInvestmentPDF(outputStream: OutputStream): Boolean {
        ...
        try {
            ...
            var title: Paragraph
            title = Paragraph("Investment Deatils", titleFont)
